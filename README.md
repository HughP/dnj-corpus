...
2. Replace Non-breaing space U+00A0 with normal space U+0020 target 374 instances.
```
...
```
6. Correct double apostrophe to proper quote marks.
...
sed -e 's/“/ˮ/g' -i proof-of-concept-text.txt
```
There are still some quotes hanging around.


**Still not completed:**
8. Corrected bad commas U+201A --> U+002C
